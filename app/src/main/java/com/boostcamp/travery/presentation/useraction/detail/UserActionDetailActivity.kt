package com.boostcamp.travery.presentation.useraction.detail
...
import com.boostcamp.travery.presentation.useraction.save.UserActionSaveActivity
...
class UserActionDetailActivity : BaseActivity<ActivityUserActionDetailBinding>(), UserActionDetailViewModel.Contract {
            ...
            if (resultCode == Activity.RESULT_OK) {
                data?.let {
                    ...
                    setResult(Activity.RESULT_OK, Intent().apply {
                        ...
                        putExtra(Constants.EXTRA_USER_ACTION_STATE, Constants.EDIT_STATE)
                    })
                }
            }
        }
    ...
    override fun deletedUserAction(userAction: UserAction) {
        setResult(Activity.RESULT_OK, Intent().apply {
            ...
            putExtra(Constants.EXTRA_USER_ACTION_STATE, Constants.DELETE_STATE)
        })
        finish()
    }
}
